...
var makeTransfer = function makeTransfer(transfer) {
  return _axios.default.post("".concat(url, "/").concat(transfer.id), transfer).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // import { formValidation } from './account.validations';
...
(0, _helpers.onUpdateField)('type', function (event) {
  ...
  formValidation.validateField('type', account.type).then(function (result) {
...
(0, _helpers.onUpdateField)('alias', function (event) {
  ...
  formValidation.validateField('alias', account.alias).then(function (result) {
...
},{"../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
