...
exports.sendMessage = exports.getPropertyDetail = exports.getEquipmentsList = void 0;
...
var getEquipmentsList = function getEquipmentsList() {
  return _axios.default.get(equipmentsUrl).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
var sendMessage = function sendMessage(message) {
  return _axios.default.post("".concat(url, "/").concat(id), message).then(function (_ref3) {
    var data = _ref3.data;
    return data;
  });
};
...
var mapPropertyApiToVm = function mapPropertyApiToVm(property, equipmentList) {
  return {
    ...
    rooms: "".concat(property.rooms, " ").concat(getWord(property.rooms, 'habitaciones', 'habitación')),
...
(0, _helpers.onSubmitForm)('contact-button', function () {
  ...
  _propertyDetail4.formValidation.validateForm(contact).then(function (result) {
    ...
    (0, _propertyDetail.sendMessage)(message);
  });
});
