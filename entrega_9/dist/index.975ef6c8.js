...
const printName = ()=>{
    const data = _dataJs.getName();
    let text = "";
    for (element of data)text = _utilsJs.createParagraph(element);
    return text;
};
...
parcelHelpers.export(exports, "getBirthday", ()=>getBirthday
);
parcelHelpers.export(exports, "getNickname", ()=>getNickname
);
const getName = ()=>{
...
const getImage = ()=>{
    fetch("https://www.breakingbadapi.com/api/characters").then((response)=>response.json()
        ...
        for (item of data)return item.img;
    }).catch((error)=>{
...
const getBirthday = ()=>{
    fetch("https://www.breakingbadapi.com/api/characters").then((response)=>response.json()
        ...
        for (item of data)console.log(item.birthday);
    }).catch((error)=>{
...
const getNickname = ()=>{
    fetch("https://www.breakingbadapi.com/api/characters").then((response)=>response.json()
        ...
        for (item of data)console.log(item.nickname);
    }).catch((error)=>{
...
parcelHelpers.export(exports, "createParagraph", ()=>createParagraph
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}]},["f5cXK","8lqZg"], "8lqZg", "parcelRequire1e52")
